# memory: stack space and heap space
...
# space: all teh variable will be copied and save in each level of the stack, including the returned value
# 1. definition of the recurrsion: what are the inputs, what are the outputs
# 2. how the return can be got from the f(n-1)
# 3.exit when to return
